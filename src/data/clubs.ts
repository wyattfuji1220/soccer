...
export const clubs: Club[] = [
  ...
  },
  {
    ...
    article: "KベールスホットVA",
    countries: ["BEL"],
    currentPlayers: ["ポープ・ウィリアム", "永長鷹虎", "原口元気"],
    pastPlayers: [
  ...
  },
  {
    ...
    article: "レギア・ワルシャワ",
    countries: ["POL"],
    currentPlayers: ["福田心之助"],
    pastPlayers: [
      { nameJa: "森下龍矢", years: "2024", loan: true },
    ],
  },
  {
    slug: "schalke-04",
  ...
  {
    slug: "royal-charleroi",
    name: "シャルルロワSC",
    nameEn: "Royal Charleroi SC",
    article: "シャルルロワSC",
    countries: ["BEL"],
    currentPlayers: ["名和田我空"],
    pastPlayers: [
  ...
  },
  {
    ...
    pastPlayers: [
      ...
      { nameJa: "永長鷹虎", years: "2022-", loan: false },
  ...
  },
  {
    ...
    pastPlayers: [
      ...
      { nameJa: "福田心之助", years: "2023-", loan: false },
  ...
  },
  {
    ...
    pastPlayers: [
      ...
      { nameJa: "永長鷹虎", years: "2023", loan: true },
  ...
  },
  {
    ...
    pastPlayers: [
      ...
      { nameJa: "名和田我空", years: "2025-", loan: false },
    ],
  },
  {
    slug: "fortuna-dusseldorf",
    name: "フォルトゥナ・デュッセルドルフ",
    nameEn: "Fortuna Düsseldorf",
    article: "フォルトゥナ・デュッセルドルフ",
    countries: ["GER"],
    currentPlayers: [],
    pastPlayers: [
  ...
  },
  {
    ...
    pastPlayers: [
      ...
      { nameJa: "中村敬斗", years: "2023-2026", loan: false },
    ],
  },
  {
  ...
  },
  {
    ...
    currentPlayers: [],
    pastPlayers: [
      { nameJa: "浦田樹", years: "2016", loan: true },
      { nameJa: "永長鷹虎", years: "2025", loan: true },
    ],
  },
  {
