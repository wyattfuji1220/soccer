...
const sections: Section[] = [
  ...
  },
  {
    h: "当サイトが収集しない情報",
    p: [
      "当サイトは静的なウェブサイトとして構築されており、会員登録やお問い合わせフォームなど、ユーザーが個人情報を入力する仕組みを設けていません。氏名、メールアドレス、住所などをこちらから取得することはありません。",
      "視聴プラン診断で選択した内容は、ご利用のブラウザ内でのみ処理され、サーバーに送信・保存されることはありません。",
    ],
  },
  {
    h: "免責事項",
