...
const sections = [
  ...
  },
  {
    h: "著作権について",
    p: [
      "当サイトは、選手の写真、クラブのエンブレム、リーグのロゴを自ら掲載しません。画面はテキストと自作のデザイン要素で構成しています。",
      "例外は、権利者自身が公開している動画です。放送・配信の権利者が公式チャンネルに投稿したものに限り、YouTubeの公式プレーヤーを埋め込むか、サムネイルを添えてリンクします。動画を当サイトが保存したり配信したりすることはありません。",
